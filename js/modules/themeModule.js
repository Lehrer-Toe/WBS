// js/modules/themeModule.js - Korrigierte Version
...
let tempCategories = [];
let themeViewMode = "cards";
let currentAssessmentTemplate = null;
...
export async function initThemeModule() {
  ...
  // Zusätzliche Event-Listener für System-Events
  ...
  console.log("Themen-Modul erfolgreich initialisiert");
}
...
/**
 * Richtet System-Event-Listener ein
 */
...
function updateThemesList(themes = null) {
  ...
  // Themen als Karten rendern
  renderThemesAsCards(themes);
}

/**
 * Rendert Themen als Kartenlayout
 */
...
/**
 * Event-Listener für Themen-Karten
 */
...
function showStudentsManagement(theme) {
  ...
  // Add-Student-Button aktualisieren
...
/**
 * Erstellt Template-Auswahl für Bewertung
 */
...
/**
 * Hilfsfunktion um aktuell ausgewählten Schüler zu finden
 */
...
/**
 * Zeigt Theme-Details in der Übersicht
 */
